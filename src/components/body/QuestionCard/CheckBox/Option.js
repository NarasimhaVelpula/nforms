...
function Option(props) {
    ...
    return (
        <div className="option">
            <CheckBoxOutlineBlankOutlinedIcon />  <InputOrLabel text={value} label={label} changeHandler={handleChange} foc={foc} /><IconButton onClick={deleteOption1}><DeleteForeverRoundedIcon /></IconButton>
        </div>
    )
}
